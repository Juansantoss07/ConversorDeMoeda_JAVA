package br.com.juancunha.menu;

import br.com.juancunha.modelos.Conversor;
import br.com.juancunha.modelos.ExchangeRateAPI;
...
public class Menu {
    ...
    public void converter (String base_code, String target_code){
        ...
        try {
            ...
            ExchangeRateAPI api = new ExchangeRateAPI(conversor);
